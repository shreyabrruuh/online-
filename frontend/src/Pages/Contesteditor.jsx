...
const Contesteditor = () => {
  ...
  useEffect(() => {
    const fetchCode = async () => {
      try {
        const response = await axios.get(`${API_BASE_URL}/code/get/${id}`);
    ...
    const fetchProblem = async () => {
      try {
        ...
        const response = await axios.get(`${API_BASE_URL}/allContestProblembyId/${id}`);
  ...
  const handleSubmission = async () => {
    ...
    try {
      const { data } = await axios.post(`${API_BASE_URL}/submission`, payload);
  ...
  const handleSubmit = async () => {
    ...
    try {
      const { data } = await axios.post(`${API_BASE_URL}/Contestsubmit`, payload);
      console.log(data);
  ...
  const handleDelete = async () => {
    try {
      await axios.delete(`${API_BASE_URL}/problem/${id}`);
