...
const EditProb = () => {
  ...
  const fetchProblem = async (problemId) => {
    try {
      const response = await axios.get(`http://localhost:8000/problem/${problemId}`);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`http://localhost:8000/problem/${id}`, formData);
  ...
  return (
    <div className="max-w-lg mx-auto p-6 bg-white rounded-lg shadow-md mt-24">
      <h2 className="text-2xl font-bold mb-6">Edit This Problem</h2>
